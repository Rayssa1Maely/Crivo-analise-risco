                    ...
                    <form action="/crivo/avaliacoes/salvar" method="POST">
                        ...
                        <div class="mb-5">
                            ...
                            <div class="flex flex-row-reverse justify-end items-center gap-1">
                                ...
                                <?php for ($i = 5; $i >= 1; $i--): ?>
                                    <input type="radio" id="star<?php echo $i; ?>" name="nota" value="<?php echo $i; ?>" class="peer hidden" <?php echo ($i === 5) ? 'required' : ''; ?>>

                                    <label for="star<?php echo $i; ?>"
                                        class="cursor-pointer text-gray-300 peer-hover:text-yellow-400 peer-checked:text-yellow-400 transition-colors duration-200">
                            ...
                            <p class="text-xs text-gray-500 mt-2">Clique na estrela para definir a nota (1 a 5).</p>
                        </div>
