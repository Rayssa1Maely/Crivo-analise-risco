            ...
            <form action="/crivo/login" method="POST" class="mt-8">
                <?php if (isset($_GET['msg']) && $_GET['msg'] == 'cadastro_sucesso'): ?>
                    <div class="bg-green-100 border-l-4 border-green-500 text-green-700 p-4 mb-6 shadow-sm rounded-r-lg">
                        <p class="font-black text-sm uppercase tracking-widest mb-1">Tudo certo!</p>
                        <p class="text-sm font-medium">Seu cadastro foi realizado com sucesso. Faça seu login abaixo.</p>
                    </div>
                <?php endif; ?>

                <?php if (isset($_GET['erro'])): ?>
                    <div class="bg-red-100 border-l-4 border-red-500 text-red-700 p-4 mb-6 shadow-sm rounded-r-lg text-left">
                        <p class="font-black text-sm uppercase tracking-widest mb-1">Aviso</p>
                        <p class="text-sm font-medium">Não foi possível conectar com a sua conta do Google. Por favor, tente novamente ou use e-mail e senha.</p>
                    </div>
                <?php endif; ?>
